...
if(isset($_POST['insert_cat'])){
    ...
    $insert_query="insert into `categories` (cat_name) values('$category_title')";
...
<div class="input-group w-90 mb-2">
  <span class="input-group-text" id="basic-addon1 bg-info"><i class="fa-solid fa-reciept"></i></span>
...
<input type="Submit" class=" bg-info border-0 my-3 p-2" name="insert_cat" value="Insert Categories">
